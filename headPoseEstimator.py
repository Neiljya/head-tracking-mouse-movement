...
class HeadPoseEstimator:
    ...
    def process_img(self, img, moveMouse= True, drawMask= True, blinkAnnot= True, displayAngle= True):
        ...
        if blinkAnnot:
            display_img = self.__display_EAR(display_img, detection_result)
        return display_img
    ...
    def __display_EAR(self, rgb_image, detection_result):
        face_landmarks_list = detection_result.face_landmarks
        annotated_image = np.copy(rgb_image)
